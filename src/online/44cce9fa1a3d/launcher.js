...
const RELEASE_DIR = '44cce9fa1a3d'; // set by build_www.sh
...
<div id="content" class="overlay" style="width: 1024px; max-width: 100%; margin: auto; font-family: Calibri, sans">
  <h1 style="text-align: center">
    莽兜世界网页版<br/>Minetest Education Web Edition
  </h1>
  <img src="/imgs/pc-light.png" alt="Minetest Education Edition Screenshot" class="center"/>
  <div class="row">
    <div class="column">
        <p>Known issues:</p>
        <p>
            <ul>
            <li>Using latest Chrome Browser</li>
            <li>'Browse Online Content' is broken on Firefox/Safari</li>
            <li>No saved files. Worlds and mods are lost when page is closed or reloaded.</li>
            <li>Network play is some lag or unable for Websocket proxy.</li>
            <li>The Inventory "i" key is changed to "Tab" key.</li>
            <li>No IME supports yet.</li>
            <li>No mobile supports yet.</li>
            <li>Currently demo only</li>
            <li>To reduce the size, only basic mods(mesecons) are installed</li>
            <li>It will download about 30 megabytes, please be patient.</li>
            <li>When the system is ready, click the button below to start.</li>
            </ul>
        </p>
    </div>
    <div class="column">
        ...
        <p>
            <ul>
            <li>请尽量使用最新的Chrome浏览器</li>
            <li>Firefox/Safari浏览器无法<b>浏览在线内容</b></li>
            <li>无法保存任何配置或文件(包括模组),一旦重新刷新页面,创建的世界或安装的模组就会丢失</li>
            <li>无法联机游戏</li>
            <li>背包(物品栏)默认按键("i")已改为"TAB"键</li>
            <li>无法输入中文,不支持IME</li>
            <li>只能在电脑上操作,手机上无法操作</li>
            <li>目前仅供演示</li>
            <li>为了减少体积,只安装了基本模组,可以实验黄石电路,其它模组需要自行安装</li>
            <li>系统会下载大约30多兆的数据,请耐心等待.</li>
            <li>当系统准备好,下方出现按钮后点击即开始.</li>
        </ul>
        </p>
    </div>
</div>

<h1 id="plLaunch" style="text-align: center"></h1>

<hr/>
<p class="small">DISCLAIMER: THE SOFTWARE IS PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, AND HEREBY DISCLAIMS ALL IMPLIED WARRANTIES, INCLUDING ANY WARRANTY OF MERCHANTABILITY AND WARRANTY OF FITNESS FOR A PARTICULAR PURPOSE.</p>
...
function showLaunchButton() {
    ...
    launchButton.innerText = 'I understand, let me play!';
    launchButton.addEventListener('click', doLaunch);
    let el = document.getElementById('plLaunch');
...
var Module = {
    ...
    setStatus: function(text) {
        ...
        if (text.startsWith('All downloads complete')) {
            progressElement.value = null;
            progressElement.max = null;
            progressElement.hidden = true;
            return;
